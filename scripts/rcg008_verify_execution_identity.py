...
repair=pathlib.Path("prereg/RCG008_EXECUTION_ONLY_REPAIR_FREEZE.json")
original=pathlib.Path("prereg/RCG008_EXECUTION_IDENTITY_FREEZE.json")
p=repair if repair.exists() else original
...
print("RCG008_EXECUTION_IDENTITY_OK", p)
