...
p=pathlib.Path("prereg/RCG011_EXECUTION_IDENTITY_FREEZE.json")
if not p.exists(): raise SystemExit("missing RCG011 execution identity freeze")
...
print("RCG011_EXECUTION_IDENTITY_OK")
