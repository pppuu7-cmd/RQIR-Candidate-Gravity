...
"G90":(["two explicit curvature-cubic witnesses","not a physical nonlinear completion"],"CUBIC","GRAVITY_CANDIDATE_GENERATED","NO","C_COVARIANT_CANDIDATE","CANDIDATE_COMPLETION_FAMILY","YES_BUT_SELF_GENERATED","NO","NO","CANDIDATE_OWNED","FOUND_BUT_CANDIDATE_OWNED"),
...
"G96":(["constraint attribution","diagnostic connected directions"],"CUBIC_ANSATZ_DIAGNOSTIC","CANDIDATE_DIAGNOSTIC","NO","RCG002_DIAGNOSTIC","CONSTRAINT_ATTRIBUTION_DIAGNOSTIC","DIAGNOSTIC_ONLY","NO","NO","DIAGNOSTIC_ONLY","FOUND_BUT_NOT_SELECTOR_DATUM"),
