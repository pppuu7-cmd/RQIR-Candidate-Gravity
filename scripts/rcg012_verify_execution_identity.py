...
p=pathlib.Path("prereg/RCG012_EXECUTION_IDENTITY_FREEZE.json")
if not p.exists():raise SystemExit("missing RCG012 execution identity freeze")
...
print("RCG012_EXECUTION_IDENTITY_OK")
