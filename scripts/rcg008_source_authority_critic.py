...
"G90":("physical nonlinear completion","CUBIC","GRAVITY_CANDIDATE_GENERATED","NO","C_COVARIANT_CANDIDATE","CANDIDATE_COMPLETION_FAMILY","YES_BUT_SELF_GENERATED","NO","NO","CANDIDATE_OWNED","FOUND_BUT_CANDIDATE_OWNED"),
