import json, pathlib
root=pathlib.Path('compute_wave31')
...
pathlib.Path('wave31_information_firewall.json').write_text(json.dumps(out,indent=2,sort_keys=True)); print(json.dumps(out,indent=2,sort_keys=True)); assert not hits
