...
checks={
    ...
    'wave21_is_obstruction_level_only':('Blind Cross-Route Obstruction Audit' in prereg and 'obstruction-level convergence result' in prereg),
...
out={
    ...
    'correction_scope':'Text-assertion implementation only; preregistered scientific criterion and authority files unchanged.',
