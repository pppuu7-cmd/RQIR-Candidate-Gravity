...
out={'test':'information_firewall','scanned_files':sorted(scanned),'hits':hits,'signals':signals}; write('wave35_information_firewall.json',out); assert all(signals.values())
